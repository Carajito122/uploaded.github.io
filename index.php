	...
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			<div class="form-group">
				<label class="font-weight-bold">URL MEGA:</label>
				<input type="text" name="link" class="form-control" placeholder="ID: !AGBB1Sia!LeIUbctTWSCUnfShXhZB5OgtIzRA6j2iUa4etsM-pyg"this.select()" required>
			</div>
